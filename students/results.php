...
else
{
	...
	$query = "SELECT tblresult.*, st_fullname, subject_name, grade, t_fullname FROM tblresult ";
	...
	if(!empty($where_sql)){
		$query .= " WHERE $where_sql AND StudentId = " . (int)$student['st_id'] ;
	}
	else{
		$query .= " WHERE StudentId = "  . (int) $student['st_id'] ;
	}
	...
	<div class="graph-visual tables-main">
		<div class="grid-1" id="printable">
            <div class="card bg-transparent mt-2">
                <div class="card-body" >
                    <table id="example" border="1" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Student Id</th>
