...
<!--
	Author: Shem
	Developed By Antipas Shem
	
-->
<!DOCTYPE html>
<html lang="zxx">
<head>
<title>Student Management System | Home :: shemarts</title>
<!-- Meta tag Keywords -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> ORERO SCHOOL</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Student</a> </li>
				<li><a href="meadmin/index.php" ><i class="fa fa-sign-in" aria-hidden="true"></i> Admin</a> </li>
			</ul>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/landing.jpg" alt="" class="img-responsive" /> </div>
		</div>
				...
				<form action="#" method="post" class="mod2">
					...
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-phone" aria-hidden="true"></i><input name="number" type="text" required="" maxlength= "10"></li>
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			<div class="wthree-services-left">
				<img src="images/about1.jpg" alt=""  style="width:400px;height:400px;">
			</div>
			<div class="wthree-services-right">
				<img src="images/about2.jpg" alt=""  style="width:400px;height:400px;">
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>ORERO BOYS SECONDARY SCHOOL is a high performing extra county school boasting of a population of over 1800 students. It's located in Rangwe, Homabay County. </p>
			</div> 
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			...
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='79000' data-delay='.5' data-increment="10">79000
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>We pride ourselves in competeing against the best in matters co-curricular activities so as too nature the talents.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Teachers</h5>
				<p>Orero Boys is a centre of excellence that promotes and moulds the students into a better Individual in the society.</p>
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/orero.jfif" class="swipebox"><img src="images/orero.jfif" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/students.jpg" class="swipebox"><img src="images/students.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/students2.jfif" class="swipebox"><img src="images/students2.jfif" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/alumni.jpg" class="swipebox"><img src="images/alumni.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/hostel4.jpg" class="swipebox"><img src="images/hostel4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/hostel2.jpg" class="swipebox"><img src="images/hostel2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/hostel3.jpg" class="swipebox"><img src="images/hostel3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/hostel.jpg" class="swipebox"><img src="images/hostel.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/bunge.jpg" class="swipebox"><img src="images/bunge.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/cops.jpg" class="swipebox"><img src="images/cops.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Orero School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/principal.jpg" alt="">
				  <h5>Mr. Dickens Bula</h5>
				  <div class="about_opa">
					<p>Principal</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/nyiero.jpg" alt="">
				  <h5>Mr. Elly Nyiero</h5>
				  <div class="about_opa">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/anash.jpg" alt="">
				  <h5>Mr. Paul Anangwe</h5>
				  <div class="about_opa">
					<p>Deputy Principal 2</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/bursar.jpg" alt="">
				  <h5> Mrs. Evaline</h5>
				  <div class="about_opa">
					<p>Bursar</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/clerk.jpg" alt="">
				  <h5>Mr. Akhalumi Wanda</h5>
				  <div class="about_opa">
					<p>Finance Clerk</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/tumaini.jpg" alt="">
				  <h5>Mr. Tumaini Yusuf</h5>
				  <div class="about_opa">
					<p>DOS</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
...
<div id="map">
<div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=orero%20boys,%20Rangwe,%20Homabay%20County,%20kenya&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net">embed responsive google map</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>
</div>
<!-- footer -->
<div class="footer">
	<div class="container">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2022 Orero School. All rights reserved | Design by <a href="http://w3layouts.com">ShemArts.</a> Developed By Shem Antipas</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2022 Orero School. All rights reserved | Design by ShemArts.</a> Developed By ShemAntipas</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
