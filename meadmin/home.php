...
<head>
	<title>Orero School Admin | Home :: w3layouts</title>
	...
	<div class="page-container sidebar-collapsed">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>2022 Orero School. All rights reserved | Design by ShemArts. Developed By ShemAntipas</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="images/shem.jpg"></a>
			...
			<div class="menu">
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Exams</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=add-result">Add Result</a></li>
							<li id="menu-academico-boletim"><a href="home.php?ravi=view-result">View Results</a></li>
					...
					<li id="menu-academico">
						...
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=manage-fee">Manage Fee</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=add-payment">Add Payment</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=view-payments">View Payments</a></li>
						</ul>
					</li>
					...
					<li id="menu-academico"><a href="#"><i class="lnr lnr-book"></i> <span>List</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=exam-list">Exam List</a></li>
