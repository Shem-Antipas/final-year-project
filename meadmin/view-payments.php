<?php 
    ...
    if(isset($_GET['filter']))
    {
        ...
        if($student_id != 0){
            array_push( $whereSQL, "student_id=". (int)$student_id);
        }
    ...
    $results = $ravi->feepayment_info($query);
            ...
            <div class="card bg-transparent mt-2">
                <div class="card-header">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                        <input type="hidden" name="ravi" value="view-payments">
                        <div class="form-row">
                            <div class="col-sm-3">
                                <div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">Student</label>
                                    <div class="col-sm-9"> 
                                    <!-- select teachers -->
                                        <input list="students" type="text" class="form-control" name="student_id" placeholder="Student ID" >
