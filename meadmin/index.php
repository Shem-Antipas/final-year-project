...
if(isset($_POST['pwd']))
{
	...
	if($admin_username=="" || $admin_password=="" || $admin_id == "")
	{
      echo "<script>alert('Please Fill Properly');</script>";
	}
	 else
	 {
		$go = $ravi->admin_reset_pwd($admin_username, $admin_id, $admin_password);
...
<body>
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													    ...
													    <div class="login">
															<h3 class="inner-tittle t-inner">Orero School Admin Login</h3>
				...
				<div class="submit"><input type="submit" value="Login" name="admin_signin"></div>
									...
									<div class="new">
																			<p><label class=""><button id="check-pwd" type="button"  ><i> </i>Forgot Password ?</button></label></p>
																	...
																	<form id="pwd-form" method="post">
																		...
																		<input type="text" class="text" name="admin_id" placeholder="Admin ID">

																		<input type="password" placeholder="New Password" name="admin_password">
																		<div class="submit"><input type="submit" value="Reset Password" name="pwd"></div>
																		<div class="new">
																			<p><label class=""><button id="login-btn" type="button"  ><i> </i>Login</button></label></p>
